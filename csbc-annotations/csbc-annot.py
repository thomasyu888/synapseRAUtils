...
def csbc_annot(dat):
    ...
    dat.ix[(dat.individualID == 'L') | (dat.individualID == 'ML') | (
        dat.individualID == 'ML_NoLM'), 'modelSystem'] = 'ASTxCre-ERT2'
    ...
    dat.ix[dat.name.str.contains('_M') & ~dat['name'].str.contains(
        'ML'), 'experimentalCondition'] = 'ListeriaTAG immunization'
    ...
    ## specimenID
    dat.ix[dat.name.str.contains('_N'), 'specimenID'] = (dat.name.str.split('_').str[2:3]).where(
        dat.name.str.contains('_N'))
    dat.ix[dat.name.str.contains('_E'), 'specimenID'] = (dat.name.str.split('_').str[2:4]).where(
        dat.name.str.contains('_E'))
    dat.ix[dat.name.str.contains('_L'), 'specimenID'] = (dat.name.str.split('_').str[2:4]).where(
        dat.name.str.contains('_L'))
    dat.ix[dat.name.str.contains('_ML') & ~dat.name.str.contains('_noLM'), 'specimenID'] = (
        dat.name.str.split('_').str[2:4]).where(dat.name.str.contains('_ML') & ~dat.name.str.contains('_noLM'))
    dat.ix[dat.name.str.contains('_ML') & dat.name.str.contains('_noLM'), 'specimenID'] = (
        dat.name.str.split('_').str[2:5]).where(dat.name.str.contains('_ML') & dat.name.str.contains('_noLM'))
    dat.ix[dat.name.str.contains('_M') & ~dat.name.str.contains('ML'), 'specimenID'] = (
        dat.name.str.split('_').str[2:3]).where(dat.name.str.contains('_M') & ~dat.name.str.contains('ML'))
    ...
    ## experimentalTimePoint
    dat.ix[dat.name.str.contains('_N'), 'experimentalTimePoint'] = \
        (dat.name.str.split('_').str[2:3]).where(dat.name.str.contains('_N')).str[0].str[1]
    dat.ix[dat.name.str.contains('_E'), 'experimentalTimePoint'] = \
        (dat.name.str.split('_').str[2:3]).where(dat.name.str.contains('_E')).str[0].str[1]
    dat.ix[dat.name.str.contains('_L'), 'experimentalTimePoint'] = \
        (dat.name.str.split('_').str[2:3]).where(dat.name.str.contains('_L')).str[0].str[1]
    dat.ix[dat.name.str.contains('_ML') & ~dat.name.str.contains('_noLM'), 'experimentalTimePoint'] = \
        (dat.name.str.split('_').str[2:4]).where(dat.name.str.contains('_ML') & ~dat.name.str.contains('_noLM')).str[
            0].str[
            2]
    dat.ix[dat.name.str.contains('_ML') & dat.name.str.contains('_noLM'), 'experimentalTimePoint'] = \
        (dat.name.str.split('_').str[2:4]).where(dat.name.str.contains('_ML') & dat.name.str.contains('_noLM')).str[
